...
namespace WasteIntoCity.Persistance.Migrations
{
    ...
    [Migration("20250511213421_RemoveFromApplicationFieldWorkTypesAndChangedPrecisionOfCoordinates")]
    partial class RemoveFromApplicationFieldWorkTypesAndChangedPrecisionOfCoordinates
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WasteIntoCity.Persistance.Entities.WorkApplicationEntity", b =>
                {
                    ...
                    b.Property<int>("WorkReportStatusTypesId")
                        .HasColumnType("int")
                    ...
                    b.HasIndex("WorkReportStatusTypesId");

                    b.ToTable("work_applications", (string)null);
                });

            modelBuilder.Entity("WasteIntoCity.Persistance.Entities.WorkApplicationTrashTypeEntity", b =>
                {
                    b.Property<Guid>("WorksApplicationsId")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("work_applications");

                    b.Property<int>("TrashTypesId")
                        .HasColumnType("int")
                        .HasColumnName("trash_types_id");

                    b.HasKey("WorksApplicationsId", "TrashTypesId");

                    b.HasIndex("TrashTypesId");

                    b.ToTable("work_applications_trash_types", (string)null);
                });
            ...
            modelBuilder.Entity("WasteIntoCity.Persistance.Entities.WorkColleagueReportEntity", b =>
                {
                    ...
                    b.HasIndex("FromParticipantId", "AboutColleagueId", "WorksId")
                        .IsUnique();
            ...
            modelBuilder.Entity("WasteIntoCity.Persistance.Entities.WorkReportStatusTypeEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("work_report_status_types", (string)null);
                });
            ...
            modelBuilder.Entity("WasteIntoCity.Persistance.Entities.WorkApplicationEntity", b =>
                {
                    ...
                    b.HasOne("WasteIntoCity.Persistance.Entities.WorkReportStatusTypeEntity", "WorkReportStatusType")
                        .WithMany("WorkApplications")
                        .HasForeignKey("WorkReportStatusTypesId")
                        .IsRequired();
                    ...
                    b.Navigation("WorkReportStatusType");
                });
            ...
            modelBuilder.Entity("WasteIntoCity.Persistance.Entities.WorkApplicationTrashTypeEntity", b =>
                {
                    ...
                    b.HasOne("WasteIntoCity.Persistance.Entities.WorkApplicationEntity", null)
                        .WithMany()
                        .HasForeignKey("WorksApplicationsId")
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("WasteIntoCity.Persistance.Entities.WorkReportComplaintEntity", b =>
                {
                    ...
                    b.HasOne("WasteIntoCity.Persistance.Entities.WorkReportStatusTypeEntity", "WorkReportComplaintType")
                        .WithMany("WorkReportComplaints")
                        .HasForeignKey("WorkReportStatusTypesId")
                        .IsRequired();
            ...
            modelBuilder.Entity("WasteIntoCity.Persistance.Entities.WorkReportResultEntity", b =>
                {
                    ...
                    b.HasOne("WasteIntoCity.Persistance.Entities.WorkComplexityTypeEntity", "WorkComplexityType")
                        .WithMany("WorkReportResults")
                        .HasForeignKey("WorkComplexityTypeId");
